...
function Display1() {
  return (
    ...
    >
      ...
      <div className="relative mt-[72px] flex flex-col gap-4 text-white">
        ...
        <p className="mb-12 text-center text-[#ffffffb8]">
          Unite a la familia <b>Solaz</b>
        </p>
        <button className="m-auto w-fit rounded-full bg-white px-5 py-3 font-black uppercase text-red-600">
