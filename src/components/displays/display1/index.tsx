    ...
    >
      ...
      <div className="relative mt-[72px] flex h-full flex-col gap-4 text-white">
        ...
        <div className="flex h-[38%] flex-col items-center justify-between">
          <a
            className="w-fit rounded-full bg-white px-5 py-3 font-arial font-bold uppercase text-red-600 transition-colors duration-300 md:text-xl md:hover:bg-[#cbcbcb] md:hover:text-red-700"
            href="#Beneficios"
          >
